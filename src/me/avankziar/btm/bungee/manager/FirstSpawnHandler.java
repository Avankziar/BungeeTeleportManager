...
public class FirstSpawnHandler
{
	...
	public void teleportPlayerToFirstSpawn(String playerName, ServerLocation location, int delayed)
	{
		...
		teleportPlayer(player, delayed, location); //Back wurde schon gemacht
	}
	
	public void teleportPlayer(ProxiedPlayer player, int delay, ServerLocation location)
	{
		...
		plugin.getProxy().getScheduler().schedule(plugin, new Runnable()
		{
			...
			public void run()
			{
		        ...
		        plugin.getProxy().getServerInfo(location.getServer()).sendData(StaticValues.FIRSTSPAWN_TOSPIGOT, streamout.toByteArray());
				return;
			}
