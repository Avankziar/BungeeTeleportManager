...
{	
	default boolean createVII(BTM plugin, Object object) 
	{
	...
	default boolean updateDataVII(BTM plugin, Object object, String whereColumn, Object... whereObject) 
	{
		if(!(object instanceof SavePoint))
		{
			return false;
	...
	default Object getDataVII(BTM plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
	...
	default ArrayList<SavePoint> getListVII(BTM plugin, String orderByColumn,
	...
	default ArrayList<SavePoint> getTopVII(BTM plugin, String orderByColumn, int start, int end)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default ArrayList<SavePoint> getAllListAtVII(BTM plugin, String orderByColumn,
