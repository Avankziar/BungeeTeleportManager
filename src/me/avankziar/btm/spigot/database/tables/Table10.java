...
{
	default boolean createX(BTM plugin, Object object) 
	{
	...
	default boolean updateDataX(BTM plugin, Object object, String whereColumn, Object... whereObject) 
	{
		if(!(object instanceof AccessPermission))
		{
			return false;
	...
	default Object getDataX(BTM plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
	...
	default ArrayList<AccessPermission> getListX(BTM plugin, String orderByColumn,
	...
	default ArrayList<AccessPermission> getTopX(BTM plugin, String orderByColumn, int start, int end)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default ArrayList<AccessPermission> getAllListAtX(BTM plugin, String orderByColumn,
