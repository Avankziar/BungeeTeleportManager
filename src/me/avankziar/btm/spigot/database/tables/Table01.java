...
{	
	default boolean createI(BTM plugin, Object object) 
	{
	...
	default boolean updateDataI(BTM plugin, Object object, String whereColumn, Object... whereObject) 
	{
		if(!(object instanceof Home))
		{
			return false;
	...
	default Object getDataI(BTM plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
	...
	default ArrayList<Home> getListI(BTM plugin, String orderByColumn,
	...
	default ArrayList<Home> getTopI(BTM plugin, String orderByColumn, int start, int end)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default ArrayList<Home> getAllListAtI(BTM plugin, String orderByColumn,
