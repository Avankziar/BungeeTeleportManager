...
{	
	default boolean createIX(BTM plugin, Object object) 
	{
	...
	default boolean updateDataIX(BTM plugin, Object object, String whereColumn, Object... whereObject) 
	{
		if(!(object instanceof EntityTransportTicket))
		{
			return false;
	...
	default Object getDataIX(BTM plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
	...
	default ArrayList<EntityTransportTicket> getListIX(BTM plugin, String orderByColumn,
	...
	default ArrayList<EntityTransportTicket> getTopIX(BTM plugin, String orderByColumn, int start, int end)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default ArrayList<EntityTransportTicket> getAllListAtIX(BTM plugin, String orderByColumn,
