...
public class Utility
{
	...
	public void setHomesTabCompleter(Player player)
	{
		new BukkitRunnable()
		{
			...
			public void run()
			{
				...
				{
					BTM.homes.replace(player.getName(), homes);
				} else
				{
					BTM.homes.put(player.getName(), homes);
				}
			}
		}.runTaskAsynchronously(plugin);
	}
	...
	public void setPortalsTabCompleter(Player player)
	{
		new BukkitRunnable()
		{
			...
			public void run()
			{
				...
				{
					BTM.portals.replace(player.getName(), portals);
				} else
				{
					BTM.portals.put(player.getName(), portals);
				}
			}
		}.runTaskAsynchronously(plugin);
	}
	...
	public void setRTPTabCompleter(Player player)
	{
		new BukkitRunnable()
		{
			...
			public void run()
			{
				...
				for(String rtp : plugin.getYamlHandler().getRTP().getRoutesAsStrings(false))
				{
				...
				{
					BTM.rtp.replace(player.getName(), rtps);
				} else
				{
					BTM.rtp.put(player.getName(), rtps);
				}
			}
		}.runTaskAsynchronously(plugin);
	}
	...
	public void setSavePointsTabCompleter(Player player)
	{
		new BukkitRunnable()
		{
			...
			public void run()
			{
				...
				{
					BTM.savepoints.replace(player.getName(), sps);
				} else
				{
					BTM.savepoints.put(player.getName(), sps);
				}
			}
		}.runTaskAsynchronously(plugin);
	}
	...
	public void setWarpsTabCompleter(Player player)
	{
		new BukkitRunnable()
		{
			...
			public void run()
			{
				...
				{
					BTM.warps.replace(player.getName(), warps);
				} else
				{
					BTM.warps.put(player.getName(), warps);
				}
			}
		}.runTaskAsynchronously(plugin);
	}
	...
	{
		if(player.hasPermission(plugin.getYamlHandler().getCommands().getString("PermissionLevel.Global")+"*")
				|| player.hasPermission(plugin.getYamlHandler().getCommands().getString("PermissionLevel.Global")+mechanic.toString()))
		{
			return -1;
		}
		ConfigHandler cfgh = new ConfigHandler(BTM.getPlugin());
		...
		if(serverAtTheMoment.equals(serverTarget))
		{
			...
			{
				if(player.hasPermission(plugin.getYamlHandler().getCommands().getString("PermissionLevel.World")+"*")
						|| player.hasPermission(plugin.getYamlHandler().getCommands().getString("PermissionLevel.World")+mechanic.toString()))
				{
					return -1;
				}
				return 5;
			} else
			{
				if(cfgh.isWorldCluster())
				{
					for(String s : cfgh.getWorldCluster())
					{
						...
						{
							if(player.hasPermission(plugin.getYamlHandler().getCommands()
									.getString("PermissionLevel.WorldClusterSameServer")+"*")
									|| player.hasPermission(plugin.getYamlHandler().getCommands()
