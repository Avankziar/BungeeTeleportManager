...
public class WorldGuardHook
{
	...
	{
        return player.hasPermission(me.avankziar.btm.general.objecthandler.StaticValues.BYPASS_FORBIDDEN_CREATE+Mechanics.HOME.getLower()) 
        		? true 
	...
	public static boolean canCreatePortal(Player player, Location pointOne, Location pointTwo)
	{
        ...
        boolean by = player.hasPermission(me.avankziar.btm.general.objecthandler.StaticValues.BYPASS_FORBIDDEN_CREATE+Mechanics.PORTAL.getLower());
	...
	{
        return player.hasPermission(me.avankziar.btm.general.objecthandler.StaticValues.BYPASS_FORBIDDEN_CREATE+Mechanics.WARP.getLower()) 
        		? true 
        		: WorldGuard.getInstance().getPlatform().getRegionContainer().createQuery().testState(
	...
	{
        return player.hasPermission(me.avankziar.btm.general.objecthandler.StaticValues.BYPASS_FORBIDDEN_USE+Mechanics.BACK.getLower())
        		? true 
        		: WorldGuard.getInstance().getPlatform().getRegionContainer().createQuery().testState(
	...
	{
		 return player.hasPermission(me.avankziar.btm.general.objecthandler.StaticValues.BYPASS_FORBIDDEN_USE+Mechanics.DEATHBACK.getLower())
				 ? true 
					: WorldGuard.getInstance().getPlatform().getRegionContainer().createQuery().testState(
	...
	{
		return player.hasPermission(me.avankziar.btm.general.objecthandler.StaticValues.BYPASS_FORBIDDEN_USE+Mechanics.HOME.getLower())
	        	? true 
	        	: WorldGuard.getInstance().getPlatform().getRegionContainer().createQuery().testState(
	...
	{
		return player.hasPermission(me.avankziar.btm.general.objecthandler.StaticValues.BYPASS_FORBIDDEN_USE+Mechanics.PORTAL.getLower())
	        	? true 
	        	: WorldGuard.getInstance().getPlatform().getRegionContainer().createQuery().testState(
	...
	{
		return player.hasPermission(me.avankziar.btm.general.objecthandler.StaticValues.BYPASS_FORBIDDEN_USE+Mechanics.TPA_ONLY.getLower())
	        	? true 
	        	: WorldGuard.getInstance().getPlatform().getRegionContainer().createQuery().testState(
	...
	{
		return player.hasPermission(me.avankziar.btm.general.objecthandler.StaticValues.BYPASS_FORBIDDEN_USE+Mechanics.WARP.getLower())
	        	? true 
	        	: WorldGuard.getInstance().getPlatform().getRegionContainer().createQuery().testState(
	        			BukkitAdapter.adapt(player.getLocation()), WorldGuardPlugin.inst().wrapPlayer(player), WARP_USE);
	}
