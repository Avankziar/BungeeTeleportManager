...
{	
	default boolean createXIII(BungeeTeleportManager plugin, Object object) 
	{
	...
	default boolean updateDataXIII(BungeeTeleportManager plugin, Object object, String whereColumn, Object... whereObject) 
	{
		if(!(object instanceof Deathzone))
		{
			return false;
	...
	default Object getDataXIII(BungeeTeleportManager plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
	...
	default ArrayList<Deathzone> getListXIII(BungeeTeleportManager plugin, String orderByColumn,
	...
	default ArrayList<Deathzone> getTopXIII(BungeeTeleportManager plugin, String orderByColumn, int start, int end)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default ArrayList<Deathzone> getAllListAtXIII(BungeeTeleportManager plugin, String orderByColumn,
