...
public class Language
{
	...
	public enum ISO639_2B
	{
		...
		ARA, AR, ARG, ARM, ARN, ARP, ART, ARW, ASM, AST, ATH, AUS, AVA, AVE, AWA, AYM, AZE, BAD, BAI, BAK,
		...
		DZO, EFI, EGY, EKA, ELX, ENG, ENM, EPO, EST, EW, EWO, FAN, FAO, FAT, FIJ, FIL, FIN, FIU, FON, FRE,
		...
		NAP, NAU, NAV, NBI, NDE, NDO, NDS, NEP, NEW, NIA, NIC, NIU, NNO, NOB, NOG, NON, NOR, NQOO, NSO, NUB,
