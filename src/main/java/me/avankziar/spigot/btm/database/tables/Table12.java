...
{	
	default boolean createXII(BungeeTeleportManager plugin, Object object) 
	{
	...
	default boolean updateDataXII(BungeeTeleportManager plugin, Object object, String whereColumn, Object... whereObject) 
	{
		if(!(object instanceof FirstSpawn))
		{
			return false;
	...
	default Object getDataXII(BungeeTeleportManager plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
	...
	default ArrayList<FirstSpawn> getListXII(BungeeTeleportManager plugin, String orderByColumn,
	...
	default ArrayList<FirstSpawn> getTopXII(BungeeTeleportManager plugin, String orderByColumn, int start, int end)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default ArrayList<FirstSpawn> getAllListAtXII(BungeeTeleportManager plugin, String orderByColumn,
